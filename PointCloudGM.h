...
class CSM_POINT_CLOUD_EXPORT_API PointCloudGM : public GeometricModel {
...
public:
	...
	//---
	virtual ModelCoord groundToModel(const EcefCoord& groundPt, double desiredPrecision = 0.001, double* achievedPrecision = NULL, WarningList* warnings = NULL) const = 0;
   ...
   virtual ModelCoordCovar groundToModel(const EcefCoordCovar& groundPt, double desiredPrecision = 0.001, double* achievedPrecision = NULL, WarningList* warnings = NULL) const = 0;
   ...
   virtual EcefCoord modelToGround(const ModelCoord& modelPt, double desiredPrecision = 0.001, double* achievedPrecision = NULL, WarningList* warnings = NULL) const = 0;
   ...
   virtual EcefCoordCovar modelToGround(const ModelCoordCovar& modelPt, double desiredPrecision = 0.001, double* achievedPrecision = NULL, WarningList* warnings = NULL) const = 0;
      //> This method converts the given modelPt (m0,m1,m2 in model
   ...
   virtual SensorPartials computeSensorPartials(int index, const EcefCoord& groundPt, double desiredPrecision = 0.001, double* achievedPrecision = NULL, WarningList* warnings = NULL) const = 0;
   ...
   virtual SensorPartials computeSensorPartials(int index, const ModelCoord& modelPt, const EcefCoord& groundPt, double desiredPrecision = 0.001, double* achievedPrecision = NULL, WarningList* warnings = NULL) const = 0;
   ...
   virtual std::vector<SensorPartials> computeAllSensorPartials(const EcefCoord& groundPt, param::Set pSet = param::VALID, double desiredPrecision = 0.001, double* achievedPrecision = NULL, WarningList* warnings = NULL) const;
      //> This is one of two overloaded methods.  This method takes only
      //  the necessary inputs.  Some efficiency may be obtained by using the
      //  other method.
      //
   ...
   virtual std::vector<SensorPartials> computeAllSensorPartials(const ModelCoord& modelPt, const EcefCoord& groundPt, param::Set pSet = param::VALID, double desiredPrecision = 0.001, double* achievedPrecision = NULL, WarningList* warnings = NULL) const;
      //> This is one of two overloaded methods.  This method takes
   ...
   inline std::vector<double> getUnmodeledError(const ModelCoord& modelPt) const { return getUnmodeledCrossCovariance(modelPt, modelPt); }
   ...
   virtual std::vector<double> getUnmodeledCrossCovariance(const ModelCoord& pt1, const ModelCoord& pt2) const = 0;
